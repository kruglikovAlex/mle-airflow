...
cv_res = cross_validate(CatBoostClassifier(auto_class_weights='Balanced'), X_tr_transformed, y_tr, scoring=['f1','roc_auc'], cv=cv_strategy) # Проведите кросс-валидацию #
